...
function cadastros(){
	candidatos[0] = new novoCandidato("João Doria", "45", "PSDB", "_imagens/joao.png", "presidente", "_imagens/thiago_lider.png");
	candidatos[1] = new novoCandidato("Geraldo Alckmin", "05", "PSDB", "_imagens/geraldo.png", "presidente", "_imagens/cristian.png");
	candidatos[2] = new novoCandidato("Aécio Neves", "02", "PSDB", "_imagens/aecio.png", "presidente", "_imagens/carlos_gom.png");
	candidatos[3] = new novoCandidato("Lula", "13", "PT", "_imagens/lula.png", "presidente", "_imagens/luis_chato.png");
	candidatos[4] = new novoCandidato("Fernando Haddad", "03", "PT", "_imagens/fernando.png", "presidente",  "_imagens/jose_da_silva.png");
	candidatos[5] = new novoCandidato("Marina Silva", "40", "Rede Sustentabilidade", "_imagens/marina.png", "presidente", "_imagens/camila_pereira.png");
	candidatos[6] = new novoCandidato("Bolsonaro", "20", "PSC", "_imagens/bolsonaro.png", "presidente", "_imagens/renato_seila.png");
	candidatos[7] = new novoCandidato("Ciro Gomes", "12", "PDT", "_imagens/ciro.png", "presidente", "_imagens/edison_barros.png");
	candidatos[8] = new novoCandidato("Alvaro Dias", "43", "PV", "_imagens/alvaro.png", "presidente", "_imagens/tomaz_enrique.png");
	candidatos[9] = new novoCandidato("Joaquim Barbosa", "07", "Não Tem", "_imagens/barbosa.png", "presidente", "_imagens/felipe_gomes.png");
}
