...
<html >
	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="tema"><b>Religião e política.</b></div>
					<div class="row">
						<div class="col-md-12">	
							<br><br>
							<div class="descricao3"><b>Em épocas passadas a Igreja Católica exercia forte poder em decisões políticas, agora os evangélicos são a força da vez. Justificada pelo crescimento das frentes mais conservadoras, o pensamento e ideologia religiosa têm se mostrado cada vez mais fortes no âmbito político. Apesar de não serem maioria, são grupos que possuem grande influência na tomada de decisões, onde temas são aprovados ou não (como: descriminalização do aborto, casamento homoafetivo, adoção por casais homossexuais, legalização da maconha) com base no que diz a bíblia.</b></div><br><br>
							<div class="descricao2"><b><i>Na sua opinião o Brasil, um país laico (quando é imparcial em relação às questões gerais, não apoiando nem se opondo a nenhuma religião) ocorre esse tipo de influência religiosa na política?</i></b></div>
							<button class="botao1" type="button" onclick="Mudarestado('minhaDiv1')"><b>Sim</b></button>
							<div id="minhaDiv1" style="display:none">
								<div class="descricao2"><b><i>Você concorda na interferência de grupos religiosos em temas sociais de interesse público da sociedade?</i></b></div>
								<form name="Licao5" action="licao6.php" method="POST">
									<input type="hidden" name="id" value="<?php echo $id ?>">
									<button class="botao4" type="submit" name="licao5" value="simConcordo"><div><b>Concordo</b></div></button>
									<button class="botao4" type="submit" name="licao5" value="simDiscordo"><div><b>Discordo</b></div></button>
								</form>
							</div>
							<button class="botao1" type="button" onclick="Mudarestado('minhaDiv2')"><b>Não</b></button>
							<div id="minhaDiv2" style="display:none">
								<div class="descricao2"><b><i>Grupos religiosos deviam ter mais ter mais influência na tomada de decisões de interesse público?</i></b></div>
								<form name="Licao5" action="licao6.php" method="POST">
									<input type="hidden" name="id" value="<?php echo $id ?>">
									<button class="botao4" type="submit" name="licao5" value="naoConcordo"><div><b>Concordo</b></div></button>
									<button class="botao4" type="submit" name="licao5" value="naoDiscordo"><div><b>Discordo</b></div></button>
								</form>
							</div>
						</div>
					</div>
