	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="descricao"><i>* Selecionamos os 12 principais partidos. Com base em lições anteriores os que estão marcados são os que podem mais se identificar com você.</i></div><br>
