				...
				<div class="row">
					<form name="Licao3" action="licao4.php" method="POST">
						<div class="col-md-12">	
							...
							<button class="botao2" type="submit" name="licao3" value="Democracia" data-hover="Democracia"><div>Sou responsável por decidir os governantes por meio do voto eleitoral, todas as importantes decisões políticas estão com a sociedade. Acredito e defendo direitos humanos fundamentais como: igualdade perante a lei, liberdade de expressão, liberdade religiosa, proteção legal e na minha participação na vida política, econômica e cultural da sociedade. Esse modelo costuma contar com os poderes Executivo, Legislativo e Judiciário, normalmente sob o comando do ou da Presidente da República o maior representante do povo.</div></button>
						</div>
						<div class="col-md-12">
							<button class="botao2" type="submit" name="licao3" value="Monarquia" data-hover="Monarquia"><div>O poder deve estar nas mãos do monarca (rei, príncipe, imperador) geralmente de forma vitalícia, ou seja ocupa o cargo até a morte, como o monarca não depende de aceitação popular para permanecer no poder, não há garantias que seus interesses coincidirão com os meus. Direitos humanos fundamentais devem ser definidos pelo governo que é chefiado pela Família Real, que tem uma linha de sucessão e a prerrogativa de se manter no poder, normalmente de maneira hereditária.</div></button>
						</div>
						<div class="col-md-12">
							<button class="botao2" type="submit" name="licao3" value="Ditadura" data-hover="Ditadura"><div>Devo abrir mão dos meus direitos civis para que todos os poderes do Estado sejam governados por uma pessoa ou por um grupo de pessoas (geralmente militares), com tirania ou violência a opositores. É um regime antidemocrático onde não existe a participação da população, o governante deve atuar de acordo com suas próprias vontades, sem que respeite meus direitos humanos fundamentais ou os da população e a divisão de poderes. Governos ditatoriais geralmente assumem o poder através de Golpes de Estado ou situações de guerra.</div></button>
						</div>
					</form>
					<br><br><br><br>
				</div>
